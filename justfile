...
_prepare_plugin_builder:
    ...
    @cargo build --package plugin-builder

_build-plugins: _prepare_plugin_builder
    @echo -e ""
    @cargo -q run --package plugin-builder -- --in-dir {{plugin_in}} --build-dir {{plugin_build}} --out-dir {{plugin_out}} 
_build-plugins-release: _prepare_plugin_builder
    @echo -e ""
    @cargo -q run --package plugin-builder -- --in-dir {{plugin_in}} --build-dir {{plugin_build}} --out-dir {{plugin_out}} --release
